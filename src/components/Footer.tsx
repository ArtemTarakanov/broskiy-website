...
const FOOTER_CONTENT = {
    ...
    telegram: 'https://t.me/broskiy_portfolio',
    github: 'https://github.com/ArtemTarakanov',
    copyright: '© 2026 BRØSKIY'
};
            ...
            <div className="container">
                <div className="footer-grid">
                    ...
                    <div className="footer-col footer-col-left">
                        <h3 className="footer-name">{FOOTER_CONTENT.name}</h3>
                    </div>


                    <div className="footer-col footer-col-center">

                        <p className="footer-role">{FOOTER_CONTENT.role}</p>
                        <div className="footer-links">

                            <a
                                href={FOOTER_CONTENT.telegram} className="footer-link" target="_blank" rel="noopener noreferrer">
                            ...
                            <a
                                href={FOOTER_CONTENT.github} className="footer-link" target="_blank" rel="noopener noreferrer">
